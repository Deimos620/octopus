...
=begin
  ...
  Allow users to Sign in without confirming their emails for now,
  as currently our project is in development cycle.
  After changing it tweak factories and specs accordingly.
=end
